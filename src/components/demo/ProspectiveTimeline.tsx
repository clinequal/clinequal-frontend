          ...
          <div key={milestone.id}>
            ...
            {hasSavings && i === detectedIdx + 1 && (
              <div className="flex">
                <div className="flex flex-col items-center w-8 shrink-0">
                  <div className="flex-1 w-0.5 bg-green-300" />
                </div>
                <div className="flex-1 py-2 pl-4">
                  <div className="bg-green-50 border border-green-200 rounded-lg px-3 py-2 inline-flex items-center gap-2">
            ...
            <div className="flex">
              ...
              <div className="flex flex-col items-center w-8 shrink-0">
                {/* Dot */}
                {isDetected ? (
                  <div className="w-7 h-7 rounded-full bg-green-500 flex items-center justify-center ring-4 ring-green-100 shrink-0">
                    <svg className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                ) : isTraditional ? (
                  <div className="w-7 h-7 rounded-full bg-red-500 flex items-center justify-center ring-4 ring-red-100 shrink-0">
                    <svg className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </div>
                ) : (
                  <div className="w-7 h-7 rounded-full bg-slate-100 flex items-center justify-center border-2 border-slate-200 shrink-0">
              ...
              <div className={`flex-1 pl-4 ${isLast ? "" : "pb-5"}`}>
                ...
                <h4
                  className={`text-sm font-medium mt-0.5 ${
                    isNeutral ? "text-slate-600" : "text-slate-900"
                  }`}
                >
                  {milestone.label}
                </h4>
