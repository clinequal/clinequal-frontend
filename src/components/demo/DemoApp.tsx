  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 right-0 z-10">
        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-slate-900 text-white rounded-bl-lg">
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-6 text-left">
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-900">What you&apos;ll see:</strong>
                </p>
