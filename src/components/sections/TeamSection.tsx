...
const scientificBoard: TeamMember[] = [
  {
    name: "Daniela Terracciano",
    role: "Scientific Board",
    expertise: "Associate Professor in Clinical Pathology",
    linkedin: "https://www.linkedin.com/in/daniela-terracciano-7a74051a6/",
    image: "/team/daniela.jpeg",
  },
  {
    name: "Michela Gravina",
    role: "Scientific Board",
    expertise: "Researcher in AI applied to Biomedical Engineering",
    linkedin: "https://www.linkedin.com/in/michela-gravina/",
    image: "/team/michela.jpeg",
  },
  {
    name: "Mario Sansone",
    role: "Scientific Board",
    expertise: "Associate Professor in Biomedical Engineering",
    linkedin: "https://www.linkedin.com/in/mario-sansone-75b4843a/",
    image: "/team/mario.jpeg",
  },
  {
    name: "Adrian Elmi Telander",
    role: "Scientific Board",
    expertise: "Full Professor of Neurology",
  },
];
...
const advisoryBoard: TeamMember[] = [
  {
    ...
    role: "Advisor",
    expertise: "Independent Advisor, CEO of Volano",
    linkedin: "https://www.linkedin.com/in/giovanni-de-caro-948a3411/",
    image: "/team/giovanni.jpeg",
  },
  {
    name: "Anita Chavan",
    role: "Advisor",
    expertise: "Neuroscience researcher, startup expert and consultant for startup studios",
    linkedin: "https://www.linkedin.com/in/dranitachavan/",
    image: "/team/anita.png",
  },
  {
    name: "Magnus Magnusson",
    role: "Advisor",
    expertise: "Angel investor, CEO of Capital4D",
    linkedin: "https://www.linkedin.com/in/bmmagnusson/",
    image: "/team/magnus.png",
  },
];

function MemberCard({ member }: { member: TeamMember }) {
  return (
    <div className="text-center group bg-white dark:bg-slate-800/80 rounded-xl p-5 border border-primary/20 dark:border-primary/30 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/35 hover:-translate-y-1 hover:border-primary/40 transition-all duration-300">
      {/* Photo */}
      ...
      <Container className="relative">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300">
            Expertise spanning AI/ML, bioinformatics, healthcare data science, software engineering, and regulatory compliance.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center mt-20 mb-12">
          <h3 className="text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-primary-dark to-primary-light dark:from-slate-300 dark:to-primary-light bg-clip-text text-transparent">Scientific Board</h3>
          <p className="text-lg text-slate-600 dark:text-slate-300">
            World-class researchers in clinical pathology, biomedical engineering, AI, and neurology.
          </p>
        </div>

        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {scientificBoard.map((member) => (
            <MemberCard key={member.name} member={member} />
          ))}
        </div>
        ...
        {/* Advisory Board */}
        <div className="max-w-3xl mx-auto text-center mt-20 mb-12">
          <h3 className="text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-primary-dark to-primary-light dark:from-slate-300 dark:to-primary-light bg-clip-text text-transparent">Advisory Board</h3>
          <p className="text-lg text-slate-600 dark:text-slate-300">
            Expertise in startups, health tech, and strategic growth.
          </p>
        </div>
